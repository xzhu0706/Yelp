...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, offset: Int?, sort: YelpSortMode?, categories: [String]?, completion: @escaping ([Business]?, Error?) -> Void) -> Void {
        _ = YelpClient.sharedInstance.searchWithTerm(term, offset: offset, sort: sort, categories: categories, openNow: false, completion: completion)
    }
}
